...
private val RMapDarkBackground = Color(0xFF15151B)
private val RMapDarkSurface = Color(0xFF202029)
private val RMapDarkSurfaceSoft = Color(0xFF282936)
private val RMapDarkSurfaceMuted = Color(0xFF1B1B23)
private val RMapDarkBorder = Color(0xFF3F3F4A)
private val RMapDarkDivider = Color(0xFF32323D)
private val RMapDarkText = Color(0xFFF8FAFC)
private val RMapDarkTextSecondary = Color(0xFFCBD5E1)
private val RMapDarkTextTertiary = Color(0xFF94A3B8)
...
val OnBackgroundLight = RMapInk
val SurfaceLight = RMapSurface
val OnSurfaceLight = RMapInk
...
val InverseSurfaceLight = RMapInk
...
val SecondaryDark = RMapDarkTextSecondary
val OnSecondaryDark = RMapInk
val SecondaryContainerDark = RMapDarkSurfaceSoft
val OnSecondaryContainerDark = RMapDarkTextSecondary
val TertiaryDark = Color(0xFFC4B5FD)
val OnTertiaryDark = RMapInk
val TertiaryContainerDark = Color(0xFF3B2C62)
val OnTertiaryContainerDark = Color(0xFFEDE9FE)
val ErrorDark = Color(0xFFFF8A8A)
val OnErrorDark = RMapInk
val ErrorContainerDark = Color(0xFF4A1D1D)
val OnErrorContainerDark = Color(0xFFFFD6D6)
val BackgroundDark = RMapDarkBackground
val OnBackgroundDark = RMapDarkText
val SurfaceDark = RMapDarkSurface
val OnSurfaceDark = RMapDarkText
val SurfaceVariantDark = RMapDarkSurfaceSoft
val OnSurfaceVariantDark = RMapDarkTextSecondary
val SurfaceContainerDark = RMapDarkSurface
val SurfaceContainerLowDark = RMapDarkSurfaceMuted
val SurfaceContainerHighDark = RMapDarkSurfaceSoft
val OutlineDark = RMapDarkBorder
val OutlineVariantDark = RMapDarkDivider
val InverseSurfaceDark = RMapDarkText
