...
import com.rmap.mobile.features.profile.presentation.components.header.GuestWelcomeCard
    ...
    Scaffold(
        ...
        topBar = {
            ProfileSettingsTopBar(
                titleResId = R.string.profile_header_title,
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            LazyColumn(
                ...
                contentPadding = PaddingValues(
                    ...
                    top = innerPadding.calculateTopPadding() + Dimens.spacingLg,
                ...
                if (uiState.isLoading) {
                    ...
                    item {
                        if (uiState.isAuthenticated) {
                            ...
                            GuestWelcomeCard(
                                onLoginClick = { onSettingClick(ProfileSettingAction.PersonalInfo) }
                            )
                        }
                    }
